...
/* JavaScript content from js/midterm/addCtrl.js in folder common */
app.controller('AddCtrl', function($scope, FriendManager, Contacts, Notification, $window, $ionicLoading, $location) {
