...
/* JavaScript content from js/lib/openfb.js in folder common */
/**
...
var openFB = (function() {
    ...
    function login(scope, success, error) {
        ...
        loginWindow = window.open(FB_LOGIN_URL + '?client_id=' + fbAppId + '&redirect_uri=' + oauthRedirectURL + '&version=2.0' +
