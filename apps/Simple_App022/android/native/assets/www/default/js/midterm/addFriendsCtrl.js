...
/* JavaScript content from js/midterm/addFriendsCtrl.js in folder common */
app.controller('AddFriendsCtrl', function($scope, FriendManager, SettingManager, Contacts, Notification, $window, $ionicLoading, $location, $http) {
